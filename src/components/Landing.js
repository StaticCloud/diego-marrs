            ...
            <animated.div style={fadeIn} className="flex flex-row md:flex-row-reverse flex-wrap mx-auto justify-center">
                <div className="max-w-4xl px-5 flex items-center">
                    <div className='text-center'>
                        <h1 className="text-5xl md:text-7xl font-semibold p-2 md:py-3">Hello, I'm Diego Marrs</h1>
                        <p className="text-lg md:text-2xl p-2 md:py-3 text-gray-400 max-w-xl mx-auto">I'm a full stack web developer from Portland, OR. I'm proficient in various market-driven technologies.</p>
