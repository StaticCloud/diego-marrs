                ...
                <div className={`max-w-2xl px-6 select-none`}>
                    ...
                    <div className="flex">
                        {page.stack.map((technology, i) => 
                            <p key={i} className="pr-1 text-gray-400">
                                {technology} 
                    ...
                    <a className="transition-all my-1 mr-3 text-2xl text-gray-400 hover:text-white" href={page.app} target="_blank">
                        Deployed App
                    </a>
                    <p className="inline-flex text-2xl"> | </p>
                    <a className="transition-all my-1 ml-3 text-2xl text-gray-400 hover:text-white" href={page.github} target="_blank">
                        GitHub
                    </a>
                </div>
            </div>
